...
Estado atual: existe uma primeira SPA estática em `/notas/`, em modo demonstração, com dados fictícios e cliente Graph apenas para autenticação/verificação estrutural das futuras listas `NOTAS_*`. Ela não substitui o provisionamento real nem autoriza criação de recursos Microsoft 365.
