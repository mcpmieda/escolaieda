...
conferir(cssComponentes.includes(".notesNameCell:hover") && cssComponentes.includes("background: #071832") && cssComponentes.includes("z-index: 100"), "Hover do aluno deve ser opaco e ficar acima da tabela.");
